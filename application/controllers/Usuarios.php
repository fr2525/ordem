...
class Usuarios extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules('password', 'Senha', 'required|min_length[4]|max_length[100]');
    ...
    public function edit($usuario_id = NULL)
    {
        ...
        if (!$usuario_id || !$this->ion_auth->user($usuario_id)->row()) {
            ...
            $this->form_validation->set_rules('first_name', '', 'trim|required');
            $this->form_validation->set_rules('last_name', '', 'trim|required');
            $this->form_validation->set_rules('email', '', 'trim|required|valid_email|callback_email_check[users.email]');
            $this->form_validation->set_rules('username', '', 'trim|required|callback_username_check[users.username]');
