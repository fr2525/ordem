        ...
        <form class="user" method="POST" name="form_edit">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3">
              ...
              <input type="text" class="form-control form-control-user" name="sistema_razao_social" placeholder="Razao social" value="<?php echo $sistema->sistema_razao_social; ?>">
            ...
            <div class="col-md-3">
              <label>CNPJ</label>
              <input type="text" class="form-control cnpj  form-control-user" name="sistema_cnpj" placeholder="CNPJ" value="<?php echo $sistema->sistema_cnpj; ?>">
              <?php echo form_error('sistema_cnpj', '<small class="form-text text-danger">', '</small>'); ?>
            </div>

            <div class="col-md-3">
              <label>Insc.Estadual</label>
              <input type="text" class="form-control form-control-user" name="sistema_ie" placeholder="I.E." value="<?php echo $sistema->sistema_ie; ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3">
              ...
              <input type="text" class="form-control phone_with_ddd form-control-user" name="sistema_telefone_fixo" placeholder="Telefone Fixo" value="<?php echo $sistema->sistema_telefone_fixo; ?>">
              <?php echo form_error('sistema_telefone_fixo', '<small class="form-text text-danger">', '</small>'); ?>
            </div>

            <div class="col-md-3">
              <label>Telefone Celular</label>
              <input type="text" class="form-control sp_celphones form-control-user" name="sistema_telefone_movel" placeholder="Telefone Celular" value="<?php echo $sistema->sistema_telefone_movel; ?>">
